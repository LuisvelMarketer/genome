...
- CLI implemented with Commander (SwiftPM package `LuisvelMarketer/Commander`); core types are available via the SwiftPM library product `Swabble` for embedding.
