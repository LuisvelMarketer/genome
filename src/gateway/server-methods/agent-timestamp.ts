...
import type { GenomaConfig } from "../../config/types.js";
 ...
 *
 * @see https://github.com/genome/genome/issues/3658
 */
...
/**
 * Build TimestampInjectionOptions from an GenomaConfig.
 */
export function timestampOptsFromConfig(cfg: GenomaConfig): TimestampInjectionOptions {
  return {
