...
import { resolveGenomaAgentDir } from "../../agent-paths.js";
...
import { resolveGenomaDocsPath } from "../../docs-path.js";
...
import { createGenomaCodingTools, resolveToolLoopDetectionConfig } from "../../pi-tools.js";
...
export async function runEmbeddedAttempt(
  ...
  try {
    ...
    const agentDir = params.agentDir ?? resolveGenomaAgentDir();
    ...
    const docsPath = await resolveGenomaDocsPath({
      workspaceDir: effectiveWorkspace,
    ...
    try {
      ...
      try {
        ...
        // double-compaction. See: https://github.com/genoma/genoma/issues/9282
        ...
        if (promptError && promptErrorSource === "prompt" && !compactionOccurredThisAttempt) {
          try {
            sessionManager.appendCustomEntry("genoma:prompt-error", {
              timestamp: Date.now(),
              runId: params.runId,
              sessionId: params.sessionId,
              provider: params.provider,
      ...
      // See: https://github.com/genoma/genoma/issues/8643
