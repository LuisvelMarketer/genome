...
// NOTE(LuisvelMarketer): Upstream read now does file-magic MIME detection; we keep the wrapper
...
function resolveAdaptiveReadMaxBytes(options?: GenomaReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createGenomaReadTool(base, {
...
export function createGenomaReadTool(
  base: AnyAgentTool,
  options?: GenomaReadToolOptions,
): AnyAgentTool {
