...
```json5
{
  agent: { workspace: "~/.genoma/workspace" },
  channels: { whatsapp: { allowFrom: ["+15555550123"] } },
}
```

保存到 `~/.genoma/genoma.json`，你就可以从该号码私信机器人了。
...
```json5
{
  ...
  session: {
    ...
    store: "~/.genoma/agents/default/sessions/sessions.json",
  ...
  channels: {
    ...
    discord: {
      ...
      dm: { enabled: true, allowFrom: ["LuisvelMarketer"] },
      guilds: {
        "123456789012345678": {
