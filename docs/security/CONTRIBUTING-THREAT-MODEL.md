# Contributing to the Genoma Threat Model

Thanks for helping make Genoma more secure. This threat model is a living document and we welcome contributions from anyone - you don't need to be a security expert.

## Ways to Contribute

### Add a Threat

Spotted an attack vector or risk we haven't covered? Open an issue on [genoma/trust](https://github.com/genoma/trust/issues) and describe it in your own words. You don't need to know any frameworks or fill in every field - just describe the scenario.
...
> **This is for adding to the threat model, not reporting live vulnerabilities.** If you've found an exploitable vulnerability, see our [Trust page](https://trust.genoma.ai) for responsible disclosure instructions.
...
- [Genoma Threat Model](./THREAT-MODEL-ATLAS.md)

## Contact

- **Security vulnerabilities:** See our [Trust page](https://trust.genoma.ai) for reporting instructions
- **Threat model questions:** Open an issue on [genoma/trust](https://github.com/genoma/trust/issues)
- **General chat:** Discord #security channel

## Recognition

Contributors to the threat model are recognized in the threat model acknowledgments, release notes, and the Genoma security hall of fame for significant contributions.
