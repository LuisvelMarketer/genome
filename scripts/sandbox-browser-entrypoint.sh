...
export DISPLAY=:1
export HOME=/tmp/genoma-home
export XDG_CONFIG_HOME="${HOME}/.config"
export XDG_CACHE_HOME="${HOME}/.cache"

CDP_PORT="${GENOMA_BROWSER_CDP_PORT:-${GENOMA_BROWSER_CDP_PORT:-9222}}"
CDP_SOURCE_RANGE="${GENOMA_BROWSER_CDP_SOURCE_RANGE:-${GENOMA_BROWSER_CDP_SOURCE_RANGE:-}}"
VNC_PORT="${GENOMA_BROWSER_VNC_PORT:-${GENOMA_BROWSER_VNC_PORT:-5900}}"
NOVNC_PORT="${GENOMA_BROWSER_NOVNC_PORT:-${GENOMA_BROWSER_NOVNC_PORT:-6080}}"
ENABLE_NOVNC="${GENOMA_BROWSER_ENABLE_NOVNC:-${GENOMA_BROWSER_ENABLE_NOVNC:-1}}"
HEADLESS="${GENOMA_BROWSER_HEADLESS:-${GENOMA_BROWSER_HEADLESS:-0}}"
ALLOW_NO_SANDBOX="${GENOMA_BROWSER_NO_SANDBOX:-${GENOMA_BROWSER_NO_SANDBOX:-0}}"
NOVNC_PASSWORD="${GENOMA_BROWSER_NOVNC_PASSWORD:-${GENOMA_BROWSER_NOVNC_PASSWORD:-}}"
DISABLE_GRAPHICS_FLAGS="${GENOMA_BROWSER_DISABLE_GRAPHICS_FLAGS:-1}"
DISABLE_EXTENSIONS="${GENOMA_BROWSER_DISABLE_EXTENSIONS:-1}"
RENDERER_PROCESS_LIMIT="${GENOMA_BROWSER_RENDERER_PROCESS_LIMIT:-2}"
