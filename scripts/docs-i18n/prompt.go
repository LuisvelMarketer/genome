...
- Keep product names in English: Genome, Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the Genome Gateway, use “Gateway 网关”.
